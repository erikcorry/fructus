...
//      +6, +7        the three-register forms: no immediate, don't care
//
// 2. opcode[0] IS sel[0].  The imm3 index is {byte1[1:0], opcode[0]} - the spec
...
//
// 3. THE TWO 5-BIT TABLES SHARE THEIR COMPLEMENT HALF.  For both immbit5 and
...
//
// 4. imm3 AND shift3 ARE ONE TABLE.  They differ at index 0 alone, -1 against
...
module immgen (
    ...
    // --- the mode mux -------------------------------------------------------
    // +6 and +7 are the three-register forms and have no immediate; leaving
    // them x rather than 0 lets the mapper treat them as don't-cares.
